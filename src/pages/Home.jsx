...
import HouseCard from '../components/cards/houses/HouseCard'
  ...
  return (
    <>
      ...
      <section className='flex flex-col'>
        ...
        <Accordeon />
        <button className=' mb-10 flex items-center align-center justify-between self-center bg-primary-500 text-white rounded-xl p-2 '>
          J'ai encore des questionnements
          <img className='ms-3' src={rightArrow} />
        </button>
      </section>
      <section className='bg-gray-100'>

        <div className=" p-20 flex flex-col">
          <h2 className='text-center text-primary-500 my-12'>Nos derniers articles du moment</h2>
          <div className="grid grid-cols-3 gap-4 mx-6">
            <Article />
            <Article />
            <Article />
          </div>
        <button className=' my-14 flex items-center align-center justify-between self-center bg-primary-600 text-white rounded-xl p-2 '>
          En découvrir plus
          <img className='ms-3' src={rightArrow} />
        </button>
        </div>
